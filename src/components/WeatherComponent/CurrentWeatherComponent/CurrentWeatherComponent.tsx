                ...
                <div className={classes.currentWeatherContainer}>
                    <div className={classes.mainWeatherDataContainer}>
                        ...
                        <div className={classes.containerWithIcon}>
                            <img className={classes.weatherIcon} alt={"icon"} src={weatherIcon}/>
                            <div className={classes.weatherInfo}>
                                <span className={"mainTemperature"}>{currentWeather.main.temp}</span>
                                <span className={"weatherType"}>{currentWeather.weather[0].main}</span>
                                <span className={"minMaxTemperature"}>{`${currentWeather.main.temp_min} / ${currentWeather.main.temp_max}`}</span>
                            </div>
                        </div>
                </div>

                <div className={classes.additionalInfo}>
                    <AdditionalInfoBoxComponent>{{name:"Feels like", value: currentWeather.main.feels_like}}</AdditionalInfoBoxComponent>
